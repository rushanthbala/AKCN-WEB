...
export class AllConnectionComponent implements AfterViewInit, OnInit {
  ...
  TICKET_DATA=[]
  dataSource: any;
  displayedColumns: string[] = ['connectionID','firstName','primaryPhone','connectionAddress','connectionStatus','connectedDate'];
  ...
  getPendingData() {
      this.dataServise.getData(`connection/subscriber`).subscribe((res) => {
