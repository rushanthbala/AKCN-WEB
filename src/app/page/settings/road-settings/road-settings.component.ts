...
import { RoadDialogComponent } from 'src/app/core/dialogBox/settings/road-dialog/road-dialog.component';
import { ThisReceiver } from '@angular/compiler';

@Component({
  selector: 'app-users-setting',
  templateUrl: './road-settings.component.html',
  styleUrls: ['./road-settings.component.scss'],
})
export class RoadSettingsComponent implements AfterViewInit, OnInit {
  TICKET_DATA: any = [];
  dataSource: any;
  displayedColumns: string[] = ['id', 'road', 'areaID'];
  ...
  UpadteUserDialogBox(): void {
    const dialogRef = this.dialog.open(RoadDialogComponent, {
      width: '250px',
