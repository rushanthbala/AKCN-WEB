...
@NgModule({
  declarations: [
    ...
    PendingOneTicketComponent,
    CustomButtonComponent,
    FilterBoxComponent,
    DialogBoxComponent,
    ChangeRequestComponent,
    PendingDetailsComponent,
    PendingChangeRequestComponent,
    ...
    ReconnectBigDialogComponent,
    EditConnectionDialogComponent,
    EditSubscriberDialogComponent,
    ApplyDiscountDialogBoxComponent,
    UpdatePaymentComponent,
    CreateTicketComponentDialog,
    AssignRequestDetailsComponent,
    AssignRequestComponent,
    EditRequestComponent,
    CreateRequestComponent,
    PendingRequestDetailsComponent,
    PendingRequestComponent,
    CloseRequestDetailsComponent,
    CloseRequestComponent,
    CancelledRequestDetailsComponent,
    CancelledRequestComponent,
    TicketCancelDialogBoxComponent,
    AssignTicketRequestDilogComponent,
    TicketCloseDialogBoxComponent,
    DisconnectDialogBoxComponent,
    ExtraRequestDialogBoxComponent,
